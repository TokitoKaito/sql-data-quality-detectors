...
Part of a QA portfolio alongside [steam-store-search-qa](https://github.com/TokitoKaito/steam-store-search-qa) (manual UI testing) and [steam-web-api-postman](https://github.com/TokitoKaito/steam-web-api-postman) (API testing). The third layer of the same portfolio: defects that never surface in the interface.
...
I recorded two findings as questions rather than defects, because the answer does not follow from the data.
